...
WikiToPDF is a Python script that downloads an entire video game wiki and converts it into a series of PDF files. It is designed to be a powerful tool for creating an interactive version of any game wiki by putting it into a format that can be read by Gemini's NotebookLM product.
